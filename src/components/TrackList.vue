<template>
  <div class="track-list">
    <ContextMenu ref="menu">
      ...
      <div
        class="item"
        v-show="extraContextMenuItem.includes('removeTrackFromPlaylist')"
    ...
    <div :style="listStyles">
      <TrackListItem
        ...
        :track-prop="track"
        :hightlight-playing-track="highlightPlayingTrack"
...
export default {
  ...
  props: {
    ...
    type: { type: String, default: 'tracklist' }, // tracklist | album | playlist | cloudDisk
    id: { type: Number, default: 0 },
    dbclickTrackFunc: { type: String, default: 'default' },
    albumObject: {
      type: Object,
      default: () => {
        return {
    ...
    columnNumber: { type: Number, default: 4 },
  ...
  methods: {
    ...
    openMenu(e, traget, index = -1) {
      this.rightClickedTrack = traget;
