/**
 * ************ 歌单信息 api **********************
 * 对歌单添加或删除歌曲 addOrRemoveTrackFromPlaylist
 * 新建歌单 createPlaylist
 * 删除歌单 deletePlaylist
 * 获取每日推荐歌单 dailyRecommendPlaylist
 * 每日推荐歌曲 dailyRecommendTracks
 * 获取歌单详情 getPlaylistDetail
 * 获取精品歌单 highQualityPlaylist
 * 心动模式/智能播放 intelligencePlaylist
 * 推荐歌单 recommendPlaylist
 * 收藏/取消收藏歌单 subscribePlaylist
